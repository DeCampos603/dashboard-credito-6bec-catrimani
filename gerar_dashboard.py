...
.tbl-wrap.can-scroll-left, .tbl-scroll.can-scroll-left {
  box-shadow: var(--shadow), inset 14px 0 12px -12px rgba(0,0,0,.22);
}
.tbl-wrap.can-scroll-right, .tbl-scroll.can-scroll-right {
  box-shadow: var(--shadow), inset -14px 0 12px -12px rgba(0,0,0,.22);
}
.tbl-wrap.can-scroll-left.can-scroll-right, .tbl-scroll.can-scroll-left.can-scroll-right {
  box-shadow: var(--shadow), inset 14px 0 12px -12px rgba(0,0,0,.22), inset -14px 0 12px -12px rgba(0,0,0,.22);
}
@media (max-width: 720px) {
  .tbl-wrap.can-scroll-right::before, .tbl-scroll.can-scroll-right::before {
...
/* ==========================================================================
   ...
   Marca cada .tbl-wrap/.tbl-scroll com can-scroll-left/can-scroll-right
   conforme a posicao de rolagem, para a sombra interna definida no CSS
   aparecer so quando ha conteudo escondido para aquele lado.
   ========================================================================== */
function bcmsUpdateScrollFade(el){
  if(!el || !el.classList || !(el.classList.contains('tbl-scroll') || el.classList.contains('tbl-wrap'))) return;
...
function bcmsRefreshScrollFades(){
  document.querySelectorAll('.tbl-scroll, .tbl-wrap').forEach(bcmsUpdateScrollFade);
}
